...
const donet = "https://wa.me/923442660814";
const owner = ["923096468650"];
const {
...
async function startHisoka() {
  ...
  const client = sansekaiConnect({
    ...
    browser: ["Wa-OpenAI - AQBhai", "Safari", "3.0"],
    auth: state,
  });
  ...
  client.ev.on("connection.update", async (update) => {
    ...
    if (connection === "close") {
      ...
      console.log(color("Donate for creator by contact us https://instagram.com/AQBhaiOfficial", "yellow"));
      console.log(color("Type /menu to see menu"));
      client.sendMessage(owner + "@s.whatsapp.net", { text: `Bot started!\n\nContact us on instagram @AQBhaiOfficial :)\n${donet}` });
    }
